 ...
 * 
 */
@WebServiceClient(name = "ConversorService", targetNamespace = "http://wsaula/", wsdlLocation = "http://localhost:8000/conversor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSORSERVICE_QNAME = new QName("http://wsaula/", "ConversorService");
    ...
    public Conversor getConversorPort() {
        return super.getPort(new QName("http://wsaula/", "ConversorPort"), Conversor.class);
    }
    ...
    public Conversor getConversorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsaula/", "ConversorPort"), Conversor.class, features);
    }
